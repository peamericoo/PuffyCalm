    ...
    <section className="px-3 py-4 sm:px-5 sm:py-6">
      <div className="mx-auto max-w-[1400px]">
        <div className="mb-4 flex items-end justify-between gap-4 sm:mb-5">
          <h2 className="font-display text-2xl font-medium tracking-tight text-foreground sm:text-3xl animate-fade-up">
            Shop by mood
          </h2>
          <Link
            href="/category/all"
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-3 md:gap-4">
          {items.map((category, index) => (
            <Link
              ...
              className={`group relative flex min-h-[200px] overflow-hidden rounded-[1.4rem] card-soft md:min-h-[240px] lg:min-h-[260px] animate-fade-up delay-${index + 1}`}
            >
              <Image
